...
class TodoController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'task.required' => 'Please enter the Task field',
            'task.min' => 'Minimum Task field 3 letters',
            'task.max' => 'Maximum Task field 25 letters',
        ]);
        ...
        Todo::create($data);
        return redirect()->route('todo')->with('success', 'Task saved successfully');
    }
